...
export function Home() {
  return (
    <div className="flex flex-1 items-start w-full max-w-screen-xl h-full">
      <Sidebar />
      <main className="w-full h-[calc(100%-45px)] overflow-y-auto overflow-x-hidden border-l border-black dark:border-white">
